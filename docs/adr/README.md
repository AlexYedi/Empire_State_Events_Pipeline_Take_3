...
> **Scope:** ADR-0…4 govern the Market-Intelligence Supabase graph. **ADR-5 / ADR-6** govern the **base event pipeline's Notion Content model** — same append-only discipline, different subsystem.
