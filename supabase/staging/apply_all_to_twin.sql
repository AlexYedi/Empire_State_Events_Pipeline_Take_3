-- apply_all_to_twin.sql — one-shot staging-twin setup
-- Target: mi-staging-twin (ytfzzsxcxxbejnowmkmk, A.Yedi). YED-130 Increment 1.
-- Run this whole file ONCE in the twin's SQL Editor (or via psql). Order matters:
--   1) Empire public schema  2) topic_intelligence  3) signal_read  4) roles/grants/definer

-- ==================== 1. Empire public schema ====================
