...
| `meta` | Meta Platforms | Meta, Meta Platforms, Meta AI, **Muse** (Meta's agent), Facebook |
...
## Notes / cautions
- **NOT aliases (sub-orgs that stay their own company row; ruled 2026-09-18):** `Meta Superintelligence Labs` is **not** folded into `meta`. It resolves to its own deterministic slug.
