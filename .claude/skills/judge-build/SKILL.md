...
## Reuses / references
- `.claude/hooks/{check-refs.sh, check-tombstones.py, density-check.sh, gemini-judge.sh, quorum-merge.sh}` · `.claude/evals/{prompts/judge-system.md, rubrics/build-quality-v4.md, README.md}` · design: `.claude/references/cross-provider-judge.md`.
