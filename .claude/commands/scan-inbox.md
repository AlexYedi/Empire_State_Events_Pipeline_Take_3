...
- **Gmail reads run in the parent in v1, by choice** (Gmail *read* tools ARE available to a subagent that declares them; verified live 2026-09-19). For `extract`, once bodies are
